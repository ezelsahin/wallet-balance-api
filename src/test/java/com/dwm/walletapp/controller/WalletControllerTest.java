...
public class WalletControllerTest {
    ...
    void getBalance() throws Exception{
        ...
        when(iWalletService.getWalletBalance(5)).thenReturn(walletBalance.getWalletBalance());
        ...
        BigDecimal actualBalance = iWalletService.getWalletBalance(5);

        assertEquals(actualBalance, BigDecimal.valueOf(1500.45));
    }
